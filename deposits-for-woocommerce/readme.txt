...
✉️ [__Custom Email Templates__](https://www.codeixer.com/docs/email-templates-for-a-deposit-order/) – Create and send personalized email templates specifically for deposit-related transactions and reminders.
...
🔔 [__Payment Reminders__](https://www.codeixer.com/docs/how-to-set-up-deposit-payment-reminders-for-customers/) – Automatically send reminder emails to customers about upcoming or overdue deposit payments.
...
* Added: Global deposit settings for all products (now support fixed and percentage)
...
[See changelog for all versions](https://plugins.svn.wordpress.org/deposits-for-woocommerce/trunk/changelog.txt).